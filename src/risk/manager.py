...
class RiskManager:
    ...
    def validate_position_size(self, signal: Signal, portfolio_value: float) -> bool:
        ...
        try:
            ...
            self.logger.error(f"Error validating position size: {e!s}")
            return False

    def calculate_stop_loss(self, entry_price: float, side: str, atr: float | None = None) -> float:
        """
        ...
        try:
            ...
            self.logger.error(f"Error calculating stop loss: {e!s}")
    ...
    def calculate_position_size_kelly(self, win_rate: float, avg_win: float, avg_loss: float,
        ...
        try:
            ...
            self.logger.error(f"Error calculating Kelly position size: {e!s}")
    ...
    def calculate_portfolio_risk(self, positions: list[dict], portfolio_value: float) -> float:
        ...
        try:
            ...
            self.logger.error(f"Error calculating portfolio risk: {e!s}")
            return 0.0
    ...
    def validate_trade_timing(self, last_trade_time: datetime | None) -> bool:
        """
