...
class TechnicalIndicators:
    ...
    def bollinger_bands(data: pd.Series, period: int = 20, std_dev: float = 2.0) -> tuple[pd.Series, pd.Series, pd.Series]:
        ...
        try:
            ...
            raise Exception(f"Error calculating Bollinger Bands: {e!s}")
    ...
    def atr(high: pd.Series, low: pd.Series, close: pd.Series, period: int = 14) -> pd.Series:
        ...
        try:
            ...
            raise Exception(f"Error calculating ATR: {e!s}")
    ...
    def rsi(data: pd.Series, period: int = 14) -> pd.Series:
        ...
        try:
            ...
            raise Exception(f"Error calculating RSI: {e!s}")
    ...
    def macd(data: pd.Series, fast_period: int = 12, slow_period: int = 26, signal_period: int = 9) -> tuple[pd.Series, pd.Series, pd.Series]:
        ...
        try:
            ...
            raise Exception(f"Error calculating MACD: {e!s}")
    ...
    def sma(data: pd.Series, period: int) -> pd.Series:
        ...
        try:
            ...
            raise Exception(f"Error calculating SMA: {e!s}")
    ...
    def ema(data: pd.Series, period: int) -> pd.Series:
        ...
        try:
            ...
            raise Exception(f"Error calculating EMA: {e!s}")
    ...
    def stochastic(high: pd.Series, low: pd.Series, close: pd.Series,
        ...
        try:
            ...
            raise Exception(f"Error calculating Stochastic: {e!s}")
    ...
    def williams_r(high: pd.Series, low: pd.Series, close: pd.Series, period: int = 14) -> pd.Series:
        ...
        try:
            ...
            raise Exception(f"Error calculating Williams %R: {e!s}")
    ...
    def obv(close: pd.Series, volume: pd.Series) -> pd.Series:
        ...
        try:
            ...
            raise Exception(f"Error calculating OBV: {e!s}")
