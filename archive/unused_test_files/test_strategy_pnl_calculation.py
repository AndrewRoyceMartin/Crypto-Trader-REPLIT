...
try:
    ...
    from src.utils.bot_pricing import BotParams, BotPricingCalculator
...
class TestStrategyPNLCalculation(unittest.TestCase):
    ...
    def test_risk_management_integration(self):
        ...
        print("✅ Risk management integration validated!")
    ...
    def test_real_okx_price_integration(self):
        ...
        try:
            ...
            print("✅ Real OKX price integration validated!")
...
def run_strategy_pnl_tests():
    ...
    print("🚀 Starting Strategy P&L Calculation Test Suite")
    print("=" * 60)
