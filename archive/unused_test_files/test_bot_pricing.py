...
from utils.bot_pricing import BotParams, BotPricingCalculator
...
def test_bot_pricing_with_live_data():
    ...
    try:
        ...
        print("Signal Test - Price below lower band:")
        ...
        print("✅ Position sizing matches bot.py risk calculations")
        print("✅ Entry/exit prices include proper slippage")
        print("✅ Stop/take levels follow bot.py percentages")
