...
// ---- Table Data-Labels Auto-apply on mutations ----
(function(){
  function apply(){ document.querySelectorAll('.table-v02').forEach(v02ApplyDataLabels); }
  const targets = ['holdings-tbody','available-tbody','trades-tbody'];
  const mo = new MutationObserver(apply);
  targets.forEach(id=>{ const el = document.getElementById(id); if (el) mo.observe(el, {childList:true}); });
